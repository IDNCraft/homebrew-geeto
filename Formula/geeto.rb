...
class Geeto < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/IDNCraft/geeto/releases/download/v0.13.0/geeto-mac"
      ...
      url "https://github.com/IDNCraft/geeto/releases/download/v0.13.0/geeto-mac-arm64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/IDNCraft/geeto/releases/download/v0.13.0/geeto-linux"
      ...
      url "https://github.com/IDNCraft/geeto/releases/download/v0.13.0/geeto-linux-arm64"
